...
<svg xmlns="http://www.w3.org/2000/svg" width="${svgWidth}" height="${svgHeight}">
  <defs>
    <clipPath id="thumbnail-clip">
      <rect x="0" y="0" width="${thumbnailWidth}" height="${thumbnailHeight}"/>
    </clipPath>
  </defs>
  <style>
    /* SVG 스타일을 여기에 추가합니다. */
  ...
  <g transform="translate(${thumbnailX}, ${thumbnailY})">
    ...
    <image class="thumbnail" xlink:href="${thumbnail}" x="0" y="0" width="${thumbnailWidth}" height="${thumbnailHeight}" clip-path="url(#thumbnail-clip)"/>
  </g>
