        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="440px" height="310px" fill="fffefe">
            <style>
                @font-face {
                    ...
                    src: url('/src/fonts/DNFForgedBlade-Bold') format('embedded-opentype'),
                    url('/src/fonts/DNFForgedBlade-Bold') format('woff'),
                    url('/src/fonts/DNFForgedBlade-Bold') format('woff2');
                }                   
