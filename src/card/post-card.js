const postcardSVG = (title, thumbnail, short_description) => {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 300" style="width: 20vw; height: auto; max-width: 500px; min-width: 400px;"> <!-- SVG의 뷰박스와 크기 설정 -->
        ...
        <text x="5%" y="75%" font-family="Arial" font-size="20" font-weight="bold" fill="#333" text-anchor="middle">${title}</text>
        <text x="5%" y="80%" font-family="Arial" font-size="16" fill="#333" text-anchor="middle">${short_description}</text>
