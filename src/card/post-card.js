...
<svg xmlns="http://www.w3.org/2000/svg" width="440px" height="310px" fill="fffefe">
    ...
    <defs>
        <clipPath id="clip-path">
            <rect rx="8" stroke="#e4e2e2" fill="#fffefe" stroke-opacity="2" width=${thumbnailWidth}  height=${thumbnailHeight} />
        </clipPath>
        <!-- 그림자 효과를 위한 필터 정의 -->
    ...
    <!-- 그림자가 있는 사각형 -->
    <rect x="5" y="5" rx="5" width="430" height="300" fill="#eaeaea" filter="url(#drop-shadow)"/>
    <!-- 썸네일 이미지 추가 -->
