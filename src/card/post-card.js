    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="430" height="160" viewBox="0 0 430 160" fill="none">
        ...
        <g data-testid="card-title" transform="translate(25, 35)">
            <g transform="translate(0, 0)">
                <!-- 패딩 적용 -->
                <text class="header" data-testid="header" x="${paddingLeft}" y="${paddingTop}">${title}</text>
            </g>
        </g>
        <g data-testid="main-card-body" transform="translate(0, 45)">
            <svg x="25" width="400" height="400" viewBox="0 0 400 400">
                <g transform="translate(0, 0)">
                    <!-- 패딩 적용 -->
                    <text class="list-style" x="${paddingLeft}" y="${paddingTop}">•</text>
                    <text class="log-title" x="${paddingLeft + 15}" y="${paddingTop + 15}">${short_description}</text>
                </g>
            </svg>
        </g>
    </svg>
