...
const createLatestCardBody = ({ posts }) => {
  ...
  <svg data-testid="lang-items" x="25" width="400" height="400" viewBox="0 0 400 400">
      <g transform="translate(0, 0)">
          ...
          <a href="${post_urls[0]}">
              <text data-testid="lang-name" x="20" y="20" class="log-title">${posts[0]?.title || "-"
        }</text>
          </a>
          <text data-testid="lang-list" class="list-style" x="5" y="43">•</text>
          <a href="${post_urls[1]}">
              <text data-testid="lang-name" x="20" y="43" class="log-title">${posts[1]?.title || "-"
        }</text>
          </a>
          <text data-testid="lang-list" class="list-style" x="5" y="66">•</text>
          <a href="${post_urls[2]}">
              <text data-testid="lang-name" x="20" y="66" class="log-title">${posts[2]?.title || "-"
        }</text>
          </a>
          <text data-testid="lang-list" class="list-style" x="5" y="89">•</text>
          <a href="${post_urls[3]}">
              <text data-testid="lang-name" x="20" y="89" class="log-title">${posts[3]?.title || "-"
        }</text>
          </a>
      </g>
  </svg>
